# Commerce Website using django framework

This website is part of the CS50 Web Programming course and it integrates the uses of Django with a database point of view with the ability to create an account, log in and either bid on active listings like you would for eBay but as well as create your own listings of items to sell.
...
💻 View Course [Here](https://www.edx.org/new/course/cs50s-web-programming-with-python-and-javascript)



![Main Page](https://i.gyazo.com/d061a0d71af22ea2b0eb2ff5ef3bf817.jpg)
